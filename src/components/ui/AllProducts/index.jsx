    ...
    return (
        <div className='container'>
            <div className="myrow row">
                <div className="colss col-12  col-md-6" data-aos="fade-left" data-aos-duration='2000'>
                    <img src={img} alt="pvc" />
                </div>
                <div className="cols1 col-12  col-md-6" data-aos="fade-right" data-aos-duration='2000'>
